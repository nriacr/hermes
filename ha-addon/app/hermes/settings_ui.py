...
SETTINGS_CSS = """
:root { color-scheme:light; --bg:#F5F4FB; --panel:#FFFFFF; --card:#FBFAFF; --line:#E9E7F5; --text:#2B2A3D; --muted:#6B6980; --accent:#D6D4FB; --accent2:#C9EEDA; --ok:#146C43; --bad:#B03A4A; --ink-faint:#9C9AB0; --surface:#FFFFFF; --surface-2:#FBFAFF; --indigo-ink:#4B47D6; --indigo-soft:#EDECFE; --mint-ink:#146C43; --mint-soft:#E4F7ED; --rose-ink:#B03A4A; --rose-soft:#FCE7EA; }
...
main { max-width:980px; margin:0 auto; padding:28px 18px 44px; } .hero { border:1px solid var(--line); border-radius:22px; padding:22px; background:var(--panel); box-shadow:0 16px 36px rgba(43,42,61,.10); }
h1 { margin:0 0 8px; color:var(--indigo-ink); font-size:34px; letter-spacing:-.04em; } h2 { margin:24px 0 10px; font-size:18px; } p { margin:0; color:var(--muted); line-height:1.5; font-size:13px; }
...
.button.primary { color:#181a2c; background:linear-gradient(135deg,var(--accent),var(--accent2)); } .button.secondary { color:var(--text); background:var(--indigo-soft); border-color:var(--line); } .button.danger { color:#fff5f7; background:var(--rose-ink); border-color:#e8a4ac; } .button.danger:hover { background:#c2455b; } .button.is-submitting { pointer-events:none; opacity:.7; }
.notice { margin:14px 0; padding:11px 13px; border-radius:12px; font-weight:700; font-size:13px; } .notice-ok { color:var(--mint-ink); background:var(--mint-soft); border:1px solid rgba(20,108,67,.28); } .notice-fail { color:var(--rose-ink); background:var(--rose-soft); border:1px solid rgba(176,58,74,.28); }
.settings-section { margin-top:18px; border:1px solid var(--line); border-radius:18px; padding:16px; background:var(--card); } details { border:1px solid var(--line); border-radius:14px; background:var(--surface-2); margin:9px 0; overflow:hidden; } summary { cursor:pointer; padding:13px 14px; font-weight:900; color:var(--text); list-style:none; } summary::-webkit-details-marker { display:none; } summary::before { content:'\u25b8'; display:inline-block; margin-right:8px; color:var(--ink-faint); } details[open] summary::before { transform:rotate(90deg); } .watch-tools { display:grid; gap:12px; } .watch-search { display:grid; gap:6px; max-width:440px; margin:0; color:var(--muted); font-size:12px; font-weight:750; } .watch-search input { width:100%; min-height:40px; border:1px solid var(--line); border-radius:11px; padding:10px 11px; background:var(--surface); color:var(--text); font:inherit; } .watch-group-filters { display:flex; flex-wrap:wrap; gap:8px; margin:0; } .watch-group-filter { min-height:34px; border:1px solid var(--line); border-radius:999px; padding:0 12px; background:var(--indigo-soft); color:var(--text); font:700 12px inherit; cursor:pointer; } .watch-group-filter[aria-pressed='false'] { color:var(--muted); background:var(--surface-2); opacity:.72; text-decoration:line-through; } .watch-group-filter:hover { border-color:#b9b6f0; } .watch-actions { display:flex; align-items:center; gap:8px; min-height:40px; }
.saving-overlay { position:fixed; inset:0; z-index:20; display:grid; place-items:center; padding:20px; background:rgba(43,42,61,.45); backdrop-filter:blur(5px); } .saving-overlay[hidden] { display:none; } .saving-dialog { width:min(100%,430px); border:1px solid var(--line); border-radius:18px; padding:22px; background:var(--surface); box-shadow:0 22px 50px rgba(43,42,61,.18); } .saving-dialog h2 { margin:0 0 9px; font-size:20px; } .saving-dialog p { font-size:14px; } .saving-spinner { width:28px; height:28px; margin:0 0 14px; border:4px solid rgba(43,42,61,.15); border-top-color:var(--indigo-ink); border-radius:50%; animation:hermes-spin .8s linear infinite; } @keyframes hermes-spin { to { transform:rotate(360deg); } }
