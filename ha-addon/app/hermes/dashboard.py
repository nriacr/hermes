...
def _render_table_row(row):
    ...
    return (
        ...
        f'<td data-label="Güncelleme" class="updated-cell">{price_age}</td></tr>'
    )
...
def _render_rows_table(rows, empty_text):
    ...
    return f"""
        <div class="table-wrap">
          <table>
            <thead><tr><th>Satıcı</th><th>Ürün Adı</th><th>Güncel</th><th>Hedef</th><th>Fark</th><th>Min / Maks</th><th>Güncelleme</th></tr></thead>
            <tbody>{body}</tbody>
          </table>
        </div>
    """
